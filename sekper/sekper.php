...
<head>
    ...
    <title>Sekretariat Perusahaan & Tata Kelola</title>
</head>
    ...
    <div class="w3-main">
        <div class="w3-light-grey">
            <div class="w3-container"><br>
                <h1>Sekretariat Perusahaan & Tata Kelola</h1>
                <div class="container my-3" style="max-width: 100%">
                    <a class="btn btn-warning" href="/tkno/sekper/create.php" role="button">
                    <i class="fa-solid fa-plus" style="color: black;"></i>
                    </a>
                    <a class="btn btn-primary" href="/tkno/sekper/history.php" role="button">
                    ...
                    <div style="display: flex; gap: 10px; justify-content:center;">
                        ...
                        <div class="card" style="width: 25%">
                            <div class="card-body">
                                ...
                                <?php
                                $sql_total_tkno_per_departemen = "SELECT departemen, SUM(formasi) as total_formasi, SUM(aktual) as total_aktual FROM sekper GROUP BY departemen";
                    ...
                    <div style="display: flex; gap: 10px; margin-right: 2px;">
                        ...
                        <select class="col form-select" id="departemenFilter">
                            ...
                            <option value="Departemen Corporate Legal">Departemen Corporate Legal</option>
                            <option value="Departemen Hubungan Masyarakat">Departemen Hubungan Masyarakat</option>
                            <option value="Departemen Tanggung Jawab Sosial & Lingkungan">Departemen Tanggung Jawab Sosial & Lingkungan</option>
                            <option value="Departemen Tata Kelola & Manajemen Risiko">Marketing Support Sumbagsel</option>
                            <option value="Kompartemen Sekretariat Perusahaan & Tata Kelola">Kompartemen Sekretariat Perusahaan & Tata Kelola</option>
                        </select>
                            ...
                            <tbody>
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    if (!empty($row['file_name'])) {
                                        ...
                                        <a class='btn-sm btn-margin' href='/tkno/sekper/uploads/$row[file_name]' target='_blank'><i class='fa-solid fa-up-right-from-square' style='color: ;'></i></a>
                                    ...
                                    echo "
                                        ...
                                        <td>
                                            <a class='btn btn-warning btn-sm btn-margin' href='/tkno/sekper/edit.php?id=$id&page=$page'><i class= 'fa-solid fa-pen-to-square' style='color: #51461f;'></i></a>
                    ...
                    <!-- Paginasi -->
                    <?php
                    $sql_total = "SELECT COUNT(*) as total FROM sekper";
   ...
   // grafik total per departemen
    ...
    var myBarChartDepartemen = new Chart(ctxBarDepartemen, {
        ...
        function deleteData(id) {
            ...
            xhr.open("GET", "/tkno/sekper/delete.php?action=delete&id=" + id, true);
        ...
        function deleteFile(id) {
            var xhr = new XMLHttpRequest();
            xhr.open("GET", "/tkno/sekper/deleteFile.php?id=" + id, true);
