    ...
    if (!empty($_FILES["uploaded_file"]["name"])) {
        ...
        if ($uploaded_file["error"] == UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($uploaded_file["tmp_name"], $target_file)) {
                ...
                $sql = "INSERT INTO sekper (direktorat, kompartemen, departemen, jenis_pekerjaan, tipe_borongan, klasifikasi, formasi, aktual, keterangan, file_name) " .
                ...
                if (!$result) {
                    ...
                    // Insert data into riwayat_sekper table with perubahan information
                    $perubahan_info = "Ditambahkan pada " . date("d/m/Y"); // Get current date
                    $sql_riwayat_sekper = "INSERT INTO riwayat_sekper (direktorat, kompartemen, departemen, jenis_pekerjaan, tipe_borongan, klasifikasi, formasi, aktual, keterangan, file_name, perubahan) " .
                    ...
                    $result_riwayat_sekper = $connection->query($sql_riwayat_sekper);

                    if (!$result_riwayat_sekper) {
                        $errorMessage = "Query tidak valid: " . $connection->error;
                    } else {
                        $direktorat = "";
                        $kompartemen = "";
...
<head>
    ...
    <title>Sekper || Tambah Data</title>
                ...
                <div class="container my-5">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="kompartemen" value="Kompartemen Sekretariat Perusahaan & Tata Kelola" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-3 d-grid">
                                <a class="btn btn-danger" button href=" /tkno/sekper/sekper.php" role="button"><b>Batal</b></a>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        $(document).ready(function() {
            <?php if (!empty($successMessage)) : ?>
                ...
                $('#successModal').on('hidden.bs.modal', function() {
                    window.location.href = '/tkno/sekper/sekper.php?page=<?php echo $total_pages; ?>#bottom';
                });
            <?php endif; ?>
        });
    </script>
