...
$sql_total = "SELECT COUNT(*) as total FROM rantai_pasok";
    ...
    if (!empty($_FILES["uploaded_file"]["name"])) {
        ...
        if ($uploaded_file["error"] == UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($uploaded_file["tmp_name"], $target_file)) {
                ...
                $sql = "INSERT INTO rantai_pasok (direktorat, kompartemen, departemen, jenis_pekerjaan, tipe_borongan, klasifikasi, formasi, aktual, keterangan, file_name) " .
                ...
                if (!$result) {
                    ...
                    // Insert data into riwayat_rantaipasok table with perubahan information
                    $perubahan_info = "Ditambahkan pada " . date("d/m/Y"); // Get current date
                    $sql_riwayat_rantaipasok = "INSERT INTO riwayat_rantaipasok (direktorat, kompartemen, departemen, jenis_pekerjaan, tipe_borongan, klasifikasi, formasi, aktual, keterangan, file_name, perubahan) " .
                    ...
                    $result_riwayat_rantaipasok = $connection->query($sql_riwayat_rantaipasok);

                    if (!$result_riwayat_rantaipasok) {
                        $errorMessage = "Query tidak valid: " . $connection->error;
                    } else {
                        $direktorat = "";
                        $kompartemen = "";
...
<head>
    ...
    <title>Rantai Pasok || Tambah Data</title>
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <select name="departemen" class="form-select">
                                        <option value="Departemen Pengadaan Barang & Jasa">Departemen Pengadaan Barang & Jasa</option>
                                        <option value="Departemen Perencanaan, Penerimaan & Pergudangan">Departemen Perencanaan, Penerimaan & Pergudangan </option>
                                        <option value="Tim HPS">Tim HPS</option>
                                        <option value="Kompartemen Rantai Pasok">Kompartemen Rantai Pasok</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-3 d-grid">
                                    <a class="btn btn-danger" button href=" /tkno/rantaipasok/rantaipasok.php" role="button"><b>Batal</b></a>
                                </div>
                            </div>
                        </form>
                        </div>
        ...
        $(document).ready(function() {
            <?php if (!empty($successMessage)) : ?>
                ...
                $('#successModal').on('hidden.bs.modal', function() {
                    window.location.href = '/tkno/rantaipasok/rantaipasok.php?page=<?php echo $total_pages; ?>#bottom';
                });
            <?php endif; ?>
        });
    </script>
