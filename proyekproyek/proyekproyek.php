        ...
        <div class="w3-light-grey">
            <div class="w3-container"><br>
                <h1>Proyek Proyek</h1>
                    ...
                    <a class="btn btn-warning" href="/tkno/proyekproyek/create.php" role="button"><i class="fa-solid fa-plus" style="color: black;"></i></a>
                    <a class="btn btn-primary" href="/tkno/proyekproyek/history.php" role="button"><i class="fa-solid fa-clock-rotate-left" style="color: black;"></i></a>
                    <br><br>
                    <div style="display: flex; gap: 10px; justify-content:center;">
                        ...
                        <div class="card" style="width: 25%">
                            <div class="card-body">
                                ...
                                <?php
                                $sql_total_tkno_per_departemen = "SELECT departemen, SUM(formasi) as total_formasi, SUM(aktual) as total_aktual FROM proyek_proyek GROUP BY departemen";
                    ...
                    <div style="display: flex; gap: 10px; margin-right: 2px;">
                        ...
                        <select class="col form-select" id="departemenFilter">
                            ...
                            <option value="Proyek Cost Reduction Program">Proyek Cost Reduction Program</option>
                            <option value="Proyek Creating Share Value">Proyek Creating Share Value</option>
                            <option value="Proyek Dapen & THT">Proyek Dapen & THT</option>
                            <option value="Proyek Implementasi Budaya Perusahaan">Proyek Implementasi Budaya Perusahaan</option>
                            <option value="Proyek Manajemen Piutang">Proyek Manajemen Piutang</option>
                            <option value="Proyek Optimalisasi Stock & Sparepart">Proyek Optimalisasi Stock & Sparepart</option>
                            <option value="Proyek Percepatan Tindak Lanjut Audit Eksternal">Proyek Percepatan Tindak Lanjut Audit Eksternal</option>
                            <option value="Proyek Pusri-IIIB">Proyek Pusri-IIIB</option>
                        </select>
                            ...
                            <tbody>
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    if (!empty($row['file_name'])) {
                                        ...
                                        <a class='btn-sm btn-margin' href='/tkno/proyekproyek/uploads/$row[file_name]' target='_blank'><i class='fa-solid fa-up-right-from-square' style='color: ;'></i></a>
                                    ...
                                    echo "
                                        ...
                                        <td>
                                            <a class='btn btn-warning btn-sm btn-margin' href='/tkno/proyekproyek/edit.php?id=$id&page=$page'><i class= 'fa-solid fa-pen-to-square' style='color: #51461f;'></i></a>
                    ...
                    <!-- Paginasi -->
                    <?php
                    $sql_total = "SELECT COUNT(*) as total FROM proyek_proyek";
   ...
   // grafik total per departemen
    ...
    var myBarChartDepartemen = new Chart(ctxBarDepartemen, {
        ...
        function deleteData(id) {
            ...
            xhr.open("GET", "/tkno/proyekproyek/delete.php?action=delete&id=" + id, true);
        ...
        function deleteFile(id) {
            var xhr = new XMLHttpRequest();
            xhr.open("GET", "/tkno/proyekproyek/deleteFile.php?id=" + id, true);
