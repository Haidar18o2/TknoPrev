...
<head>
    ...
    <title>Riwayat Transformasi Bisnis</title>
</head>
    ...
    <div class="w3-main">
        <div class="w3-light-grey">
            <div class="w3-container"><br>
                <h1>Riwayat Transformasi Bisnis</h1>
                <div class="container my-3" style="max-width: 100%">
                    <a class="btn btn-warning" href="/tkno/tb/tb.php" role="button"><i class="fa-solid fa-arrow-left"></i></a>
                    <br><br>
