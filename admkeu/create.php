...
$sql_total = "SELECT COUNT(*) as total FROM adm_keu";
    ...
    if (!empty($_FILES["uploaded_file"]["name"])) {
        ...
        if ($uploaded_file["error"] == UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($uploaded_file["tmp_name"], $target_file)) {
                ...
                $sql = "INSERT INTO adm_keu (direktorat, kompartemen, departemen, jenis_pekerjaan, tipe_borongan, klasifikasi, formasi, aktual, keterangan, file_name) " .
                ...
                if (!$result) {
                    ...
                    // Insert data into riwayat_admkeu table with perubahan information
                    $perubahan_info = "Ditambahkan pada " . date("d/m/Y"); // Get current date
                    $sql_riwayat_admkeu = "INSERT INTO riwayat_admkeu (direktorat, kompartemen, departemen, jenis_pekerjaan, tipe_borongan, klasifikasi, formasi, aktual, keterangan, file_name, perubahan) " .
                    ...
                    $result_riwayat_admkeu = $connection->query($sql_riwayat_admkeu);

                    
                    if (!$result_riwayat_admkeu) {
                        $errorMessage = "Query tidak valid: " . $connection->error;
                    } else {
                        $direktorat = "";
                        $kompartemen = "";
...
<head>
    ...
    <title>Adm. Keuangan || Tambah Data</title>
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <select name="departemen" class="form-select">
                                        ...
                                        <option value="Marketing Support Sumbagsel">Marketing Support Sumbagsel</option>
                                        <option value="UPP Cilacap">UPP Cilacap</option>
                                        <option value="Kompartemen Administrasi Keuangan">Kompartemen Administrasi Keuangan</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-3 d-grid">
                                    <a class="btn btn-danger" button href=" /tkno/admkeu/admkeu.php" role="button"><b>Batal</b></a>
                                </div>
                            </div>
                        </form>
                        </div>
    ...
    $(document).ready(function() {
        <?php if (!empty($successMessage)) : ?>
            ...
            $('#successModal').on('hidden.bs.modal', function() {
                window.location.href = '/tkno/admkeu/admkeu.php?page=<?php echo $total_pages; ?>#bottom';
            });
        <?php endif; ?>
    });
</script>
