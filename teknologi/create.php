...
$sql_total = "SELECT COUNT(*) as total FROM teknologi";
    ...
    if (!empty($_FILES["uploaded_file"]["name"])) {
        ...
        if ($uploaded_file["error"] == UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($uploaded_file["tmp_name"], $target_file)) {
                ...
                $sql = "INSERT INTO teknologi (direktorat, kompartemen, departemen,  jenis_pekerjaan, tipe_borongan, klasifikasi, formasi, aktual, keterangan, file_name) " .
                ...
                if (!$result) {
                    ...
                    // Insert data into riwayat_teknologi table with perubahan information
                    $perubahan_info = "Ditambahkan pada " . date("d/m/Y"); // Get current date
                    $sql_riwayat_teknologi = "INSERT INTO riwayat_teknologi (direktorat, kompartemen, departemen, jenis_pekerjaan, tipe_borongan, klasifikasi, formasi, aktual, keterangan, file_name, perubahan) " .
                    ...
                    $result_riwayat_teknologi = $connection->query($sql_riwayat_teknologi);

                    if (!$result_riwayat_teknologi) {
                        $errorMessage = "Query tidak valid: " . $connection->error;
                    } else {
                        $direktorat = "";
                        $kompartemen = "";
...
<head>
    ...
    <title>Teknologi || Tambah Data</title>
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <select name="departemen" class="form-select">
                                        <option value="Departemen Keselamatan & Kesehatan Kerja">Departemen Keselamatan & Kesehatan Kerja</option>
                                        ...
                                        <option value="Kompartemen Teknologi">Kompartemen Teknologi</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-3 d-grid">
                                    <a class="btn btn-danger" button href=" /tkno/teknologi/teknologi.php" role="button"><b>Batal</b></a>
                                </div>
                            </div>
                        </form>
                        </div>
        ...
        $(document).ready(function() {
            <?php if (!empty($successMessage)) : ?>
                ...
                $('#successModal').on('hidden.bs.modal', function() {
                    window.location.href = '/tkno/teknologi/teknologi.php?page=<?php echo $total_pages; ?>#bottom';
                });
            <?php endif; ?>
        });
    </script>
