...
$sql_total = "SELECT COUNT(*) as total FROM tekbang";
    ...
    if (!empty($_FILES["uploaded_file"]["name"])) {
        ...
        if ($uploaded_file["error"] == UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($uploaded_file["tmp_name"], $target_file)) {
                ...
                $sql = "INSERT INTO tekbang (direktorat, kompartemen, departemen, jenis_pekerjaan, tipe_borongan, klasifikasi, formasi, aktual, keterangan, file_name) " .
                ...
                if (!$result) {
                    ...
                    // Insert data into riwayat_tekbang table with perubahan information
                    $perubahan_info = "Ditambahkan pada " . date("d/m/Y"); // Get current date
                    $sql_riwayat_tekbang = "INSERT INTO riwayat_tekbang (direktorat, kompartemen, departemen, jenis_pekerjaan, tipe_borongan, klasifikasi, formasi, aktual, keterangan, file_name, perubahan) " .
                    ...
                    $result_riwayat_tekbang = $connection->query($sql_riwayat_tekbang);

                    if (!$result_riwayat_tekbang) {
                        $errorMessage = "Query tidak valid: " . $connection->error;
                    } else {
                        $direktorat = "";
                        $kompartemen = "";
...
<head>
    ...
    <title>Tekbang || Tambah Data</title>
                ...
                <div class="container my-5">
                    ...
                    <div class="row justify-content-md-center">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-3 col-form-label">Direktorat Operasi & Produksi </label>
                                <div class="col-sm-6">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <select name="departemen" class="form-select">
                                        <option value="Departemen Pengembangan Korporat & Bisnis">Departemen Pengembangan Korporat & Bisnis</option>
                                        <option value="Departemen Rancang Bangun & Perekayasaan">Departemen Rancang Bangun & Perekayasaan</option>
                                        <option value="Kompartemen Teknik & Pengembangan">Kompartemen Teknik & Pengembangan</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-3 d-grid">
                                    <a class="btn btn-danger" button href=" /tkno/tekbang/tekbang.php" role="button"><b>Batal</b></a>
                                </div>
                            </div>
                        </form>
                        </div>
        ...
        $(document).ready(function() {
            <?php if (!empty($successMessage)) : ?>
                ...
                $('#successModal').on('hidden.bs.modal', function() {
                    window.location.href = '/tkno/tekbang/tekbang.php?page=<?php echo $total_pages; ?>#bottom';
                });
            <?php endif; ?>
        });
    </script>
