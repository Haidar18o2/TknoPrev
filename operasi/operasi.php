        ...
        <div class="w3-light-grey">
            <div class="w3-container"><br>
                ...
                <div class="container my-3" style="max-width: 100%">
                    <a class="btn btn-warning" href="/tkno/operasi/create.php" role="button"><i class="fa-solid fa-plus" style="color: black;"></i></a>
                    <a class="btn btn-primary" href="/tkno/operasi/history.php" role="button"><i class="fa-solid fa-clock-rotate-left" style="color: black;"></i></a>
                    <br><br>
                    <div style="display: flex; gap: 10px; justify-content:center;">
                        ...
                        <div class="card" style="width: 25%">
                            <div class="card-body">
                                ...
                                <?php
                                $sql_total_tkno_per_departemen = "SELECT departemen, SUM(formasi) as total_formasi, SUM(aktual) as total_aktual FROM operasi GROUP BY departemen";
                            ...
                            <tbody>
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    if (!empty($row['file_name'])) {
                                        ...
                                        <a class='btn-sm btn-margin' href='/tkno/operasi/uploads/$row[file_name]' target='_blank'><i class='fa-solid fa-up-right-from-square' style='color: ;'></i></a>
                                    ...
                                    echo "
                                        ...
                                        <td>
                                            <a class='btn btn-warning btn-sm btn-margin' href='/tkno/operasi/edit.php?id=$id&page=$page'><i class= 'fa-solid fa-pen-to-square' style='color: #51461f;'></i></a>
   ...
   // grafik total per departemen
    ...
    var myBarChartDepartemen = new Chart(ctxBarDepartemen, {
        ...
        function deleteData(id) {
            ...
            xhr.open("GET", "/tkno/operasi/delete.php?action=delete&id=" + id, true);
        ...
        function deleteFile(id) {
            var xhr = new XMLHttpRequest();
            xhr.open("GET", "/tkno/operasi/deleteFile.php?id=" + id, true);
