...
$sql_total = "SELECT COUNT(*) as total FROM operasi";
    ...
    if (!empty($_FILES["uploaded_file"]["name"])) {
        ...
        if ($uploaded_file["error"] == UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($uploaded_file["tmp_name"], $target_file)) {
                ...
                $sql = "INSERT INTO operasi (direktorat, kompartemen, departemen, jenis_pekerjaan, tipe_borongan, klasifikasi, formasi, aktual, keterangan, file_name) " .
                ...
                if (!$result) {
                    ...
                    // Insert data into riwayat_operasi table with perubahan information
                    $perubahan_info = "Ditambahkan pada " . date("d/m/Y"); // Get current date
                    $sql_riwayat_operasi = "INSERT INTO riwayat_operasi (direktorat, kompartemen, departemen, jenis_pekerjaan, tipe_borongan, klasifikasi, formasi, aktual, keterangan, file_name, perubahan) " .
                    ...
                    $result_riwayat_operasi = $connection->query($sql_riwayat_operasi);

                    if (!$result_riwayat_operasi) {
                        $errorMessage = "Query tidak valid: " . $connection->error;
                    } else {
                        $direktorat = "";
                        $kompartemen = "";
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <select name="departemen" class="form-select">
                                        <option value="Departemen Operasi P-IB">Departemen Operasi P-IB</option>
                                        <option value="Departemen Operasi P-IIB">Departemen Operasi P-IIB</option>
                                        <option value="Departemen Operasi P-III">Departemen Operasi P-III</option>
                                        <option value="Departemen Operasi P-IV">Departemen Operasi P-IV</option>
                                        <option value="Departemen Operasi P-V">Departemen Operasi P-V</option>
                                        <option value="Departemen Operasi P-VI">Departemen Operasi P-VI</option>
                                        <option value="Kompartemen Operasi">Kompartemen Operasi</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-3 d-grid">
                                    <a class="btn btn-danger" button href=" /tkno/operasi/operasi.php" role="button"><b>Batal</b></a>
                                </div>
                            </div>
                        </form>
                        </div>
        ...
        $(document).ready(function() {
            <?php if (!empty($successMessage)) : ?>
                ...
                $('#successModal').on('hidden.bs.modal', function() {
                    window.location.href = '/tkno/operasi/operasi.php?page=<?php echo $total_pages; ?>#bottom';
                });
            <?php endif; ?>
        });
    </script>
