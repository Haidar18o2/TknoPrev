        ...
        <div class="w3-light-grey">
            <div class="w3-container"><br>
                ...
                <div class="container my-3" style="max-width: 100%">
                    <a class="btn btn-warning" href="/tkno/operasi/operasi.php" role="button"><i class="fa-solid fa-arrow-left"></i></a>
                    <br><br>
                    ...
                    <table id='historyTable' class='table table-hover table-bordered'>
                        ...
                        <tbody>
                        <?php
                        $sql = "SELECT * FROM riwayat_operasi";
